...
| `earthground kicad place`             | Place and route through KiCad IPC.    | The request involves interactively editing placements, tracks, vias, or zones.                         | [Earthground CLI](./SKILL.md)                                                           |
