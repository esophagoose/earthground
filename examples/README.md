...
For a focused Tier 2 example, see ``sn65dphy440ss.py``. It exercises the
packaged ``earthground.library.integrated_circuits.transceivers`` model for a
real D-PHY retimer, resolving its straps and required external components
